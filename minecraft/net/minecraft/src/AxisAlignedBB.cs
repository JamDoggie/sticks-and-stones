...
namespace net.minecraft.src
{
	...
	{
		private static System.Collections.IList boundingBoxes = new ArrayList();
		...
		public static AxisAlignedBB getBoundingBoxFromPool(double d0, double d2, double d4, double d6, double d8, double d10)
		{
			...
			return ((AxisAlignedBB)boundingBoxes[numBoundingBoxesInUse++]).setBounds(d0, d2, d4, d6, d8, d10);
		}
		...
		public virtual AxisAlignedBB setBounds(double d1, double d3, double d5, double d7, double d9, double d11)
		{
			this.minX = d1;
			this.minY = d3;
			this.minZ = d5;
		...
		public virtual AxisAlignedBB addCoord(double d1, double d3, double d5)
		{
			double d7 = this.minX;
			double d9 = this.minY;
		...
		public virtual AxisAlignedBB expand(double d1, double d3, double d5)
		{
		...
		public virtual AxisAlignedBB getOffsetBoundingBox(double d1, double d3, double d5)
		{
			return getBoundingBoxFromPool(this.minX + d1, this.minY + d3, this.minZ + d5, this.maxX + d1, this.maxY + d3, this.maxZ + d5);
		}

		public virtual double calculateXOffset(AxisAlignedBB axisAlignedBB1, double d2)
		{
		...
		public virtual double calculateYOffset(AxisAlignedBB axisAlignedBB1, double d2)
		{
		...
		public virtual double calculateZOffset(AxisAlignedBB axisAlignedBB1, double d2)
		{
			if (axisAlignedBB1.maxX > this.minX && axisAlignedBB1.minX < this.maxX)
			{
				if (axisAlignedBB1.maxY > this.minY && axisAlignedBB1.minY < this.maxY)
		...
		public virtual bool intersectsWith(AxisAlignedBB axisAlignedBB1)
		{
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
//ORIGINAL LINE: return axisAlignedBB1.maxX > this.minX && axisAlignedBB1.minX < this.maxX ? (axisAlignedBB1.maxY > this.minY && axisAlignedBB1.minY < this.maxY ? axisAlignedBB1.maxZ > this.minZ && axisAlignedBB1.minZ < this.maxZ : false) : false;
		...
		public virtual AxisAlignedBB offset(double d1, double d3, double d5)
		{
			this.minX += d1;
			this.minY += d3;
			this.minZ += d5;
		...
		public virtual bool isVecInside(Vec3D vec3D1)
		{
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
//ORIGINAL LINE: return vec3D1.xCoord > this.minX && vec3D1.xCoord < this.maxX ? (vec3D1.yCoord > this.minY && vec3D1.yCoord < this.maxY ? vec3D1.zCoord > this.minZ && vec3D1.zCoord < this.maxZ : false) : false;
		...
		public virtual double AverageEdgeLength
		{
			get
			{
		...
		public virtual AxisAlignedBB contract(double d1, double d3, double d5)
		{
			double d7 = this.minX + d1;
			double d9 = this.minY + d3;
			double d11 = this.minZ + d5;
		...
		public virtual AxisAlignedBB copy()
		{
			return getBoundingBoxFromPool(this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ);
		}

		public virtual MovingObjectPosition calculateIntercept(Vec3D vec3D1, Vec3D vec3D2)
		{
