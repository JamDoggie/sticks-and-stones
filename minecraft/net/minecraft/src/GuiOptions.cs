namespace net.minecraft.src
{
	public class GuiOptions : GuiScreen
	{
		...
		protected internal string screenTitle = "Options";
			...
			for (int i5 = 0; i5 < i4; ++i5)
			{
				...
				if (!enumOptions6.EnumFloat)
				{
					...
					if (enumOptions6 == EnumOptions.DIFFICULTY && this.mc.theWorld != null && this.mc.theWorld.WorldInfo.HardcoreModeEnabled)
					{
						...
						guiSmallButton7.displayString = StatCollector.translateToLocal("options.difficulty") + ": " + StatCollector.translateToLocal("options.difficulty.hardcore");
					}
		...
		protected internal override void actionPerformed(GuiButton guiButton1)
		{
			...
			{
				if (guiButton1.id < 100 && guiButton1 is GuiSmallButton)
				{
