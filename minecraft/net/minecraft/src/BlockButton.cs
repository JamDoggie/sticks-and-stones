...
namespace net.minecraft.src
{
	...
	{
		protected internal BlockButton(int i1, int i2) : base(i1, i2, Material.circuits)
		{
			TickRandomly = true;
		}
		...
		{
			if (this.redundantCanPlaceBlockAt(world1, i2, i3, i4))
			{
		...
		private bool redundantCanPlaceBlockAt(World world1, int i2, int i3, int i4)
		{
