namespace net.minecraft.src
{
	...
	{
		protected internal float[] field_1143_g = new float[256];
		protected internal float[] field_1142_h = new float[256];
		protected internal float[] field_1141_i = new float[256];
		protected internal float[] field_1140_j = new float[256];
		internal int field_1139_k = 0;
