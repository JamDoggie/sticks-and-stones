...
namespace net.minecraft.src
{
    ...
    public class BlockDispenser : BlockContainer
	{
		...
		protected internal BlockDispenser(int i1) : base(i1, Material.rock)
		{
		...
		private void dispenseItem(World world1, int i2, int i3, int i4, RandomExtended random5)
		{
			...
			{
				ItemStack itemStack12 = tileEntityDispenser11.RandomStackFromInventory;
				...
				else
				{
					...
					else if (itemStack12.itemID == Item.potion.shiftedIndex && ItemPotion.isSplash(itemStack12.ItemDamage))
					{
						EntityPotion entityPotion24 = new EntityPotion(world1, d13, d15, d17, itemStack12.ItemDamage);
					...
					{
						ItemMonsterPlacer.func_48440_a(world1, itemStack12.ItemDamage, d13 + (double)b9 * 0.3D, d15 - 0.3D, d17 + (double)b10 * 0.3D);
						world1.playAuxSFX(1002, i2, i3, i4, 0);
					}
		...
		public override void onBlockRemoval(World world1, int i2, int i3, int i4)
		{
			...
			{
				for (int i6 = 0; i6 < tileEntityDispenser5.SizeInventory; ++i6)
				{
					ItemStack itemStack7 = tileEntityDispenser5.getStackInSlot(i6);
					if (itemStack7 != null)
					{
						float f8 = this.random.NextSingle() * 0.8F + 0.1F;
						float f9 = this.random.NextSingle() * 0.8F + 0.1F;
						float f10 = this.random.NextSingle() * 0.8F + 0.1F;
						...
						while (itemStack7.stackSize > 0)
						{
							...
							EntityItem entityItem12 = new EntityItem(world1, (double)((float)i2 + f8), (double)((float)i3 + f9), (double)((float)i4 + f10), new ItemStack(itemStack7.itemID, i11, itemStack7.ItemDamage));
