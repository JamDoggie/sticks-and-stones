			...
			else
			{
				if (movingObjectPosition12.typeOfHit == EnumMovingObjectType.TILE)
				{
					...
					else
					{
						...
						if (world2.isAirBlock(i13, i14, i15) || !world2.getBlockMaterial(i13, i14, i15).Solid)
						{
				...
				else if (this.isFull == 0 && movingObjectPosition12.entityHit is EntityCow)
				{
