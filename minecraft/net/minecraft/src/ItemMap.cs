...
namespace net.minecraft.src
{
    public class ItemMap : ItemMapBase
	{
		...
		public static MapData getMPMapData(short s0, World world1)
		{
			...
			MapData mapData3 = (MapData)world1.loadItemData(typeof(MapData), "map_" + s0);
			if (mapData3 == null)
			{
		...
		public virtual MapData getMapData(ItemStack itemStack1, World world2)
		{
			(new StringBuilder()).Append("map_").Append(itemStack1.ItemDamage).ToString();
			MapData mapData4 = (MapData)world2.loadItemData(typeof(MapData), "map_" + itemStack1.ItemDamage);
			if (mapData4 == null)
			{
				itemStack1.ItemDamage = world2.getUniqueDataId("map");
				string string3 = "map_" + itemStack1.ItemDamage;
				mapData4 = new MapData(string3);
				mapData4.xCenter = world2.WorldInfo.SpawnX;
				mapData4.zCenter = world2.WorldInfo.SpawnZ;
				mapData4.scale = 3;
				mapData4.dimension = (sbyte)world2.worldProvider.worldType;
				mapData4.markDirty();
		...
		public virtual void updateMapData(World world1, Entity entity2, MapData mapData3)
		{
					...
					if ((i12 & 15) == (mapData3.field_28175_g & 15))
					{
						...
						for (int i17 = i10 - i11 - 1; i17 < i10 + i11; ++i17)
						{
							if (i12 >= 0 && i17 >= -1 && i12 < s4 && i17 < s5)
							{
									...
									for (i33 = 0; i33 < i6; ++i33)
									{
										for (i34 = 0; i34 < i6; ++i34)
										{
											...
											if (i35 > 1)
											{
												...
												if (i35 > 0 && i36 != 0 && Block.blocksList[i36].blockMaterial.Liquid)
												{
													i38 = i35 - 1;
													bool z39 = false;
													...
													do
													{
														...
														++i30;
													} while (i38 > 0 && i43 != 0 && Block.blocksList[i43].blockMaterial.Liquid);
												}
											}
								...
								{
									sbyte b45 = mapData3.colors[i12 + i17 * s4];
									sbyte b40 = (sbyte)(i38 * 4 + b42);
									if (b45 != b40)
									{
										if (i13 > i17)
										{
		...
		public override void onUpdate(ItemStack itemStack1, World world2, Entity entity3, int i4, bool z5)
		{
			if (!world2.isRemote)
			{
		...
		public override void onCreated(ItemStack itemStack1, World world2, EntityPlayer entityPlayer3)
		{
			itemStack1.ItemDamage = world2.getUniqueDataId("map");
			string string4 = "map_" + itemStack1.ItemDamage;
			...
			mapData5.scale = 3;
			mapData5.dimension = (sbyte)world2.worldProvider.worldType;
			mapData5.markDirty();
		}
	}
