...
namespace net.minecraft.src
{
	...
	public class PanelCrashReport : Panel
	{
		public PanelCrashReport(UnexpectedThrowable unexpectedThrowable1)
		{
			...
			try
			{
				string5 = string5 + "Generated " + (new SimpleDateFormat()).format(DateTime.Now) + "\n";
				string5 = string5 + "\n";
			...
			string6 = string6 + "\n";
			string6 = string6 + "\n";
			string6 = string6 + "--- BEGIN ERROR REPORT " + Convert.ToString(string6.GetHashCode(), 16) + " --------\n";
			string6 = string6 + string5;
			string6 = string6 + "--- END ERROR REPORT " + Convert.ToString(string6.GetHashCode(), 16) + " ----------\n";
			string6 = string6 + "\n";
			string6 = string6 + "\n";
