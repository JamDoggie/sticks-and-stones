...
namespace net.minecraft.src
{
	...
	public class WorldGenSwamp : WorldGenerator
	{
		...
		{
			int i6;
			for (i6 = random2.Next(4) + 5; world1.getBlockMaterial(i3, i4 - 1, i5) == Material.water; --i4)
			{
			}
					...
					if ((i8 == Block.grass.blockID || i8 == Block.dirt.blockID) && i4 < 128 - i6 - 1)
					{
						...
						for (i16 = i4 - 3 + i6; i16 <= i4 + i6; ++i16)
						{
							...
							for (i12 = i3 - i11; i12 <= i3 + i11; ++i12)
							{
								...
								{
									int i15 = i14 - i5;
									if ((Math.Abs(i13) != i11 || Math.Abs(i15) != i11 || random2.Next(2) != 0 && i10 != 0) && !Block.opaqueCubeLookup[world1.getBlockId(i12, i16, i14)])
									{
										this.func_50073_a(world1, i12, i16, i14, Block.leaves.blockID);
									}
								}
							}
						}
						...
						for (i16 = 0; i16 < i6; ++i16)
						{
							...
							{
								this.func_50073_a(world1, i3, i4 + i16, i5, Block.wood.blockID);
							}
						}
						...
						for (i16 = i4 - 3 + i6; i16 <= i4 + i6; ++i16)
						{
							...
							for (i12 = i3 - i11; i12 <= i3 + i11; ++i12)
							{
								for (i13 = i5 - i11; i13 <= i5 + i11; ++i13)
								{
									...
									{
										if (random2.Next(4) == 0 && world1.getBlockId(i12 - 1, i16, i13) == 0)
										{
										...
										if (random2.Next(4) == 0 && world1.getBlockId(i12, i16, i13 - 1) == 0)
										{
