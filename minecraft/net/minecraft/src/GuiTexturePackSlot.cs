...
namespace net.minecraft.src
{
	...
	internal class GuiTexturePackSlot : GuiSlot
	{
		...
		public GuiTexturePackSlot(GuiTexturePacks guiTexturePacks1) : base(GuiTexturePacks.func_22124_a(guiTexturePacks1), guiTexturePacks1.width, guiTexturePacks1.height, 32, guiTexturePacks1.height - 55 + 4, 36)
		{
		...
		protected internal override int Size
		{
			get
			{
				System.Collections.IList list1 = GuiTexturePacks.func_22126_b(this.parentTexturePackGui).texturePackList.availableTexturePacks();
				return list1.Count;
			}
		}
		...
		{
			System.Collections.IList list3 = GuiTexturePacks.func_22119_c(this.parentTexturePackGui).texturePackList.availableTexturePacks();
		...
		{
			System.Collections.IList list2 = GuiTexturePacks.func_22118_f(this.parentTexturePackGui).texturePackList.availableTexturePacks();
			return GuiTexturePacks.func_22116_g(this.parentTexturePackGui).texturePackList.selectedTexturePack == list2[i1];
		}
