namespace net.minecraft.src
{
	...
	{
		protected internal float[] field_1147_g = new float[256];
		protected internal float[] field_1146_h = new float[256];
		protected internal float[] field_1145_i = new float[256];
		protected internal float[] field_1144_j = new float[256];
