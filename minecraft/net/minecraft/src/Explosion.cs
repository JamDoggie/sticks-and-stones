...
namespace net.minecraft.src
{
    ...
    public class Explosion
	{
		...
		public virtual void doExplosionA()
		{
			...
			System.Collections.IList list9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, AxisAlignedBB.getBoundingBoxFromPool((double)i3, (double)i5, (double)i7, (double)i4, (double)i29, (double)i30));
			Vec3D vec3D31 = Vec3D.createVector(this.explosionX, this.explosionY, this.explosionZ);

			for (int i11 = 0; i11 < list9.Count; ++i11)
			{
				Entity entity33 = (Entity)list9[i11];
			...
			arrayList32.AddRange(this.destroyedBlockPositions);
		}
		...
		public virtual void doExplosionB(bool z1)
		{
			...
			int i7;
			int i8;
			for (i3 = arrayList2.Count - 1; i3 >= 0; --i3)
			{
				chunkPosition4 = (ChunkPosition)arrayList2[i3];
				i5 = chunkPosition4.x;
				i6 = chunkPosition4.y;
				i7 = chunkPosition4.z;
			...
			if (this.isFlaming)
			{
				for (i3 = arrayList2.Count - 1; i3 >= 0; --i3)
				{
					...
					if (i8 == 0 && Block.opaqueCubeLookup[i25] && this.explosionRNG.Next(3) == 0)
					{
