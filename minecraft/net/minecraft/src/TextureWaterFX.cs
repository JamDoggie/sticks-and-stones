namespace net.minecraft.src
{
	...
	{
		protected internal float[] red = new float[256];
		protected internal float[] green = new float[256];
		protected internal float[] blue = new float[256];
		protected internal float[] alpha = new float[256];
