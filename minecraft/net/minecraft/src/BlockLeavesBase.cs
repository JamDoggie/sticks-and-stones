namespace net.minecraft.src
{
	public class BlockLeavesBase : Block
	{
		...
		protected internal BlockLeavesBase(int i1, int i2, Material material3, bool z4) : base(i1, i2, material3)
		{
		...
		public override bool shouldSideBeRendered(IBlockAccess iBlockAccess1, int i2, int i3, int i4, int i5)
		{
			...
			return !this.graphicsLevel && i6 == this.blockID ? false : base.shouldSideBeRendered(iBlockAccess1, i2, i3, i4, i5);
		}
	}
