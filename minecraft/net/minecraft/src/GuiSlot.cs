namespace net.minecraft.src
{
	...
	public abstract class GuiSlot
	{
		...
		protected internal readonly int bottom;
		private readonly int right;
		private readonly int left;
		protected internal readonly int slotHeight;
		private int scrollUpButtonID;
		private int scrollDownButtonID;
		protected internal int mouseX;
		protected internal int mouseY;
		...
		protected internal virtual void func_27259_a(bool z1, int i2)
		{
		...
		protected internal abstract void elementClicked(int i1, bool z2);

		protected internal abstract bool isSelected(int i1);

		protected internal virtual int ContentHeight
		{
			get
			{
				return this.Size * this.slotHeight + this.field_27261_r;
			}
		}

		protected internal abstract void drawBackground();

		protected internal abstract void drawSlot(int i1, int i2, int i3, int i4, Tessellator tessellator5);

		protected internal virtual void func_27260_a(int i1, int i2, Tessellator tessellator3)
		{
		}

		protected internal virtual void func_27255_a(int i1, int i2)
		{
		}

		protected internal virtual void func_27257_b(int i1, int i2)
		{
		}
		...
		public virtual int func_27256_c(int i1, int i2)
		{
			...
			return i1 >= i3 && i1 <= i4 && i6 >= 0 && i5 >= 0 && i6 < this.Size ? i6 : -1;
		}

		public virtual void registerScrollButtons(System.Collections.IList list1, int i2, int i3)
		{
		...
		{
			int i1 = this.ContentHeight - (this.bottom - this.top - 4);
			if (i1 < 0)
			{
				i1 /= 2;
			}
		...
		public virtual void actionPerformed(GuiButton guiButton1)
		{
		...
		public virtual void drawScreen(int i1, int i2, float f3)
		{
			...
			if (mc.mcApplet.MouseState.IsButtonDown(MouseButton.Left))
			{
				if (this.initialClickY == -1.0F)
				{
					...
					if (i2 >= this.top && i2 <= this.bottom)
					{
						...
						i11 = i10 / this.slotHeight;
						if (i1 >= i8 && i1 <= i9 && i11 >= 0 && i10 >= 0 && i11 < i4)
						{
							bool z12 = i11 == this.selectedElement && DateTimeHelper.CurrentUnixTimeMillis() - this.lastClicked < 250L;
							this.elementClicked(i11, z12);
							this.selectedElement = i11;
							this.lastClicked = DateTimeHelper.CurrentUnixTimeMillis();
						}
						...
						if (i1 >= i5 && i1 <= i6)
						{
							...
							i13 = (int)((float)((this.bottom - this.top) * (this.bottom - this.top)) / (float)this.ContentHeight);
							if (i13 < 32)
							{
								i13 = 32;
							}
							...
							this.scrollMultiplier /= (float)(this.bottom - this.top - i13) / (float)i20;
						}
						else
						{
							this.scrollMultiplier = 1.0F;
			...
			else
			{
				while (true)
				{
					...
					if (i7 != 0)
					{
						...
						this.amountScrolled += (float)(i7 * this.slotHeight / 2);
					}
				}
			}
			...
			{
				this.func_27260_a(i9, i10, tessellator18);
			}

			int i14;
			for (i11 = 0; i11 < i4; ++i11)
			{
				i20 = i10 + i11 * this.slotHeight + this.field_27261_r;
				i13 = this.slotHeight - 4;
				if (i20 <= this.bottom && i20 + i13 >= this.top)
				{
			...
			if (i20 > 0 && this.ContentHeight > 0)
			{
				...
				i14 = (int)this.amountScrolled * (this.bottom - this.top - i13) / i20 + this.top;
				if (i14 < this.top)
				{
					i14 = this.top;
				}
