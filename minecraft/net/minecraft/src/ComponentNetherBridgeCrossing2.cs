...
namespace net.minecraft.src
{
	...
	public class ComponentNetherBridgeCrossing2 : ComponentNetherBridgePiece
	{
		public ComponentNetherBridgeCrossing2(int i1, RandomExtended random2, StructureBoundingBox structureBoundingBox3, int i4) : base(i1)
		{
		...
		public static ComponentNetherBridgeCrossing2 createValidComponent(System.Collections.IList list0, RandomExtended random1, int i2, int i3, int i4, int i5, int i6)
		{
			StructureBoundingBox structureBoundingBox7 = StructureBoundingBox.getComponentToAddBoundingBox(i2, i3, i4, -1, 0, 0, 5, 7, 5, i5);
			return isAboveGround(structureBoundingBox7) && StructureComponent.findIntersecting(list0, structureBoundingBox7) == null ? new ComponentNetherBridgeCrossing2(i6, random1, structureBoundingBox7, i5) : null;
		}
		...
		public override bool addComponentParts(World world1, RandomExtended random2, StructureBoundingBox structureBoundingBox3)
		{
			...
			this.fillWithBlocks(world1, structureBoundingBox3, 0, 2, 4, 0, 5, 4, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
			this.fillWithBlocks(world1, structureBoundingBox3, 4, 2, 4, 4, 5, 4, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
