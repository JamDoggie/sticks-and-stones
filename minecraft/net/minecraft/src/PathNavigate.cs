...
namespace net.minecraft.src
{
    public class PathNavigate
	{
		...
		public virtual void func_48664_a(bool z1)
		{
			this.avoidsWater = z1;
		}
		...
		public virtual void func_48663_c(bool z1)
		{
		...
		public virtual void func_48680_d(bool z1)
		{
		...
		public virtual void func_48669_e(bool z1)
		{
			this.canSwim = z1;
		}

		public virtual PathEntity getPathToXYZ(double d1, double d3, double d5)
		{
		...
		public virtual bool func_48666_a(double d1, double d3, double d5, float f7)
		{
		...
		public virtual PathEntity func_48679_a(EntityLiving entityLiving1)
		{
		...
		public virtual bool func_48667_a(EntityLiving entityLiving1, float f2)
		{
			PathEntity pathEntity3 = this.func_48679_a(entityLiving1);
			return pathEntity3 != null ? this.setPath(pathEntity3, f2) : false;
		}

		public virtual bool setPath(PathEntity pathEntity1, float f2)
		{
			if (pathEntity1 == null)
			{
			...
			else
			{
				...
				{
					this.speed = f2;
					Vec3D vec3D3 = this.EntityPosition;
		...
		public virtual void onUpdateNavigation()
		{
			...
			if (!this.noPath())
			{
				...
				if (!this.noPath())
				{
					...
					if (vec3D1 != null)
					{
						this.theEntity.MoveHelper.setMoveTo(vec3D1.xCoord, vec3D1.yCoord, vec3D1.zCoord, this.speed);
					}
				}
			}
		}
		...
		{
			Vec3D vec3D1 = this.EntityPosition;
			int i2 = this.currentPath.CurrentPathLength;

			for (int i3 = this.currentPath.CurrentPathIndex; i3 < this.currentPath.CurrentPathLength; ++i3)
			{
		...
		private Vec3D EntityPosition
		{
			get
			{
				return Vec3D.createVector(this.theEntity.posX, (double)this.PathableYPos, this.theEntity.posZ);
			}
		}
		...
		private void removeSunnyPath()
		{
			...
			{
				for (int i1 = 0; i1 < this.currentPath.CurrentPathLength; ++i1)
				{
					...
					{
						this.currentPath.CurrentPathLength = i1 - 1;
						return;
					}
				}
		...
		private bool isDirectPathBetweenPoints(Vec3D vec3D1, Vec3D vec3D2, int i3, int i4, int i5)
		{
		...
		private bool isSafeToStandAt(int i1, int i2, int i3, int i4, int i5, int i6, Vec3D vec3D7, double d8, double d10)
		{
			int i12 = i1 - i4 / 2;
			int i13 = i3 - i6 / 2;
				...
				for (int i14 = i12; i14 < i12 + i4; ++i14)
				{
					for (int i15 = i13; i15 < i13 + i6; ++i15)
					{
						...
						if (d16 * d8 + d18 * d10 >= 0.0D)
						{
							...
							if (material21 == Material.water && !this.theEntity.InWater)
							{
								return false;
							}
		...
		private bool isPositionClear(int i1, int i2, int i3, int i4, int i5, int i6, Vec3D vec3D7, double d8, double d10)
		{
