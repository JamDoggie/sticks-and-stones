...
namespace net.minecraft.src
{
	public class LongHashMap
	{
		...
		{
			return hash((int)(j0 ^ (long)((ulong)j0 >> 32)));
		}
		...
		public virtual bool containsItem(long j1)
		{
			return this.getEntry(j1) != null;
		}

		internal LongHashMapEntry getEntry(long j1)
		{
			int i3 = getHashedKey(j1);
		...
		public virtual void add(long j1, object object3)
		{
		...
		internal static int getHashCode(long j0)
		{
