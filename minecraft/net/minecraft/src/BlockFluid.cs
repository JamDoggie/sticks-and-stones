...
namespace net.minecraft.src
{
    ...
    public abstract class BlockFluid : Block
	{
		...
		public override int colorMultiplier(IBlockAccess iBlockAccess1, int i2, int i3, int i4)
		{
			...
			else
			{
				...
				for (int i8 = -1; i8 <= 1; ++i8)
				{
					...
					{
						int i10 = iBlockAccess1.getBiomeGenForCoords(i2 + i9, i4 + i8).waterColorMultiplier;
						i5 += (i10 & 16711680) >> 16;
						i6 += (i10 & 65280) >> 8;
						i7 += i10 & 255;
					}
		...
		protected internal virtual int getFlowDecay(World world1, int i2, int i3, int i4)
		{
			return world1.getBlockMaterial(i2, i3, i4) != this.blockMaterial ? -1 : world1.getBlockMetadata(i2, i3, i4);
		}

		protected internal virtual int getEffectiveFlowDecay(IBlockAccess iBlockAccess1, int i2, int i3, int i4)
		{
		...
		public override bool isBlockSolid(IBlockAccess iBlockAccess1, int i2, int i3, int i4, int i5)
		{
			Material material6 = iBlockAccess1.getBlockMaterial(i2, i3, i4);
			return material6 == this.blockMaterial ? false : (i5 == 1 ? true : (material6 == Material.ice ? false : base.isBlockSolid(iBlockAccess1, i2, i3, i4, i5)));
		}

		public override bool shouldSideBeRendered(IBlockAccess iBlockAccess1, int i2, int i3, int i4, int i5)
		{
			Material material6 = iBlockAccess1.getBlockMaterial(i2, i3, i4);
			return material6 == this.blockMaterial ? false : (i5 == 1 ? true : (material6 == Material.ice ? false : base.shouldSideBeRendered(iBlockAccess1, i2, i3, i4, i5)));
		}
		...
		public override void randomDisplayTick(World world1, int i2, int i3, int i4, RandomExtended random5)
		{
			...
			if (this.blockMaterial == Material.water)
			{
				if (random5.Next(10) == 0)
				{
					...
					if (i6 <= 0 || i6 >= 8)
					{
						world1.spawnParticle("suspended", (double)((float)i2 + random5.NextSingle()), (double)((float)i3 + random5.NextSingle()), (double)((float)i4 + random5.NextSingle()), 0.0D, 0.0D, 0.0D);
					}
				}

				for (i6 = 0; i6 < 0; ++i6)
				{
					int i7 = random5.Next(4);
					int i8 = i2;
					int i9 = i4;
					if (i7 == 0)
					{
					...
					if (world1.getBlockMaterial(i8, i3, i9) == Material.air && (world1.getBlockMaterial(i8, i3 - 1, i9).blocksMovement() || world1.getBlockMaterial(i8, i3 - 1, i9).Liquid))
					{
						float f10 = 0.0625F;
						double d11 = (double)((float)i2 + random5.NextSingle());
						double d13 = (double)((float)i3 + random5.NextSingle());
						double d15 = (double)((float)i4 + random5.NextSingle());
						if (i7 == 0)
						{
			...
			if (this.blockMaterial == Material.water && random5.Next(64) == 0)
			{
				i6 = world1.getBlockMetadata(i2, i3, i4);
				if (i6 > 0 && i6 < 8)
				{
					world1.playSoundEffect((double)((float)i2 + 0.5F), (double)((float)i3 + 0.5F), (double)((float)i4 + 0.5F), "liquid.water", random5.NextSingle() * 0.25F + 0.75F, random5.NextSingle() * 1.0F + 0.5F);
				}
			}
			...
			if (this.blockMaterial == Material.lava && world1.getBlockMaterial(i2, i3 + 1, i4) == Material.air && !world1.isBlockOpaqueCube(i2, i3 + 1, i4))
			{
				...
				{
					d21 = (double)((float)i2 + random5.NextSingle());
					d22 = (double)i3 + this.maxY;
					d23 = (double)((float)i4 + random5.NextSingle());
					world1.spawnParticle("lava", d21, d22, d23, 0.0D, 0.0D, 0.0D);
					world1.playSoundEffect(d21, d22, d23, "liquid.lavapop", 0.2F + random5.NextSingle() * 0.2F, 0.9F + random5.NextSingle() * 0.15F);
				}

				if (random5.Next(200) == 0)
				{
					world1.playSoundEffect((double)i2, (double)i3, (double)i4, "liquid.lava", 0.2F + random5.NextSingle() * 0.2F, 0.9F + random5.NextSingle() * 0.15F);
				}
			}

			if (random5.Next(10) == 0 && world1.isBlockNormalCube(i2, i3 - 1, i4) && !world1.getBlockMaterial(i2, i3 - 2, i4).blocksMovement())
			{
				d21 = (double)((float)i2 + random5.NextSingle());
				d22 = (double)i3 - 1.05D;
				d23 = (double)((float)i4 + random5.NextSingle());
		...
		protected internal virtual void triggerLavaMixEffects(World world1, int i2, int i3, int i4)
		{
			...
			{
				world1.spawnParticle("largesmoke", (double)i2 + portinghelpers.MathHelper.NextDouble, (double)i3 + 1.2D, (double)i4 + portinghelpers.MathHelper.NextDouble, 0.0D, 0.0D, 0.0D);
			}
		}
	}
