namespace net.minecraft.src
{
	public class GuiMemoryErrorScreen : GuiScreen
	{
		...
		public override void drawScreen(int i1, int i2, float f3)
		{
			...
			this.drawString(this.fontRenderer, "Java Virtual Machine not being allocated enough", this.width / 2 - 140, this.height / 4 - 60 + 60 + 27, 10526880); // Leaving this message alone for the novelty of it.
