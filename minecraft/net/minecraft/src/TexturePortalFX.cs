...
namespace net.minecraft.src
{
	...
	public class TexturePortalFX : TextureFX
	{
			...
			for (int i2 = 0; i2 < 32; ++i2)
			{
				for (int i3 = 0; i3 < 16; ++i3)
				{
					for (int i4 = 0; i4 < 16; ++i4)
					{
						...
						for (i6 = 0; i6 < 2; ++i6)
						{
							float f7 = (float)(i6 * 16) * 0.5F;
							float f8 = (float)(i6 * 16) * 0.5F;
						...
						int i16 = i4 * 16 + i3;
						this.portalTextureData[i2][i16 * 4 + 0] = (sbyte)i13;
						this.portalTextureData[i2][i16 * 4 + 1] = (sbyte)i14;
						this.portalTextureData[i2][i16 * 4 + 2] = (sbyte)i6;
						this.portalTextureData[i2][i16 * 4 + 3] = (sbyte)i15;
					}
				}
			}
		...
		public override void onTick()
		{
			...
			sbyte[] b1 = this.portalTextureData[this.portalTickCounter & 31];
