...
namespace net.minecraft.src
{
	...
	public class WorldGenHugeTrees : WorldGenerator
	{
		...
		public WorldGenHugeTrees(bool z1, int i2, int i3, int i4) : base(z1)
		{
			this.field_48195_a = i2;
					...
					if ((i8 == Block.grass.blockID || i8 == Block.dirt.blockID) && i4 < 256 - i6 - 1)
					{
						...
						for (i10 = 0; i10 < i6; ++i10)
						{
							...
							if (i11 == 0 || i11 == Block.leaves.blockID)
							{
								...
								if (i10 > 0)
								{
									if (random2.Next(3) > 0 && world1.isAirBlock(i3 - 1, i4 + i10, i5))
									{
										this.setBlockAndMetadata(world1, i3 - 1, i4 + i10, i5, Block.vine.blockID, 8);
									}

									if (random2.Next(3) > 0 && world1.isAirBlock(i3, i4 + i10, i5 - 1))
									{
							...
							if (i10 < i6 - 1)
							{
								...
								if (i11 == 0 || i11 == Block.leaves.blockID)
								{
									...
									if (i10 > 0)
									{
										if (random2.Next(3) > 0 && world1.isAirBlock(i3 + 2, i4 + i10, i5))
										{
											this.setBlockAndMetadata(world1, i3 + 2, i4 + i10, i5, Block.vine.blockID, 2);
										}

										if (random2.Next(3) > 0 && world1.isAirBlock(i3 + 1, i4 + i10, i5 - 1))
										{
								...
								if (i11 == 0 || i11 == Block.leaves.blockID)
								{
									...
									if (i10 > 0)
									{
										if (random2.Next(3) > 0 && world1.isAirBlock(i3 + 2, i4 + i10, i5 + 1))
										{
											this.setBlockAndMetadata(world1, i3 + 2, i4 + i10, i5 + 1, Block.vine.blockID, 2);
										}

										if (random2.Next(3) > 0 && world1.isAirBlock(i3 + 1, i4 + i10, i5 + 2))
										{
								...
								if (i11 == 0 || i11 == Block.leaves.blockID)
								{
									...
									if (i10 > 0)
									{
										...
										if (random2.Next(3) > 0 && world1.isAirBlock(i3, i4 + i10, i5 + 2))
										{
		...
		private void func_48192_a(World world1, int i2, int i3, int i4, int i5, RandomExtended random6)
		{
			...
			for (int i8 = i4 - b7; i8 <= i4; ++i8)
			{
				...
				for (int i11 = i2 - i10; i11 <= i2 + i10 + 1; ++i11)
				{
					...
					{
						int i14 = i13 - i3;
						if ((i12 >= 0 || i14 >= 0 || i12 * i12 + i14 * i14 <= i10 * i10) && (i12 <= 0 && i14 <= 0 || i12 * i12 + i14 * i14 <= (i10 + 1) * (i10 + 1)) && (random6.Next(4) != 0 || i12 * i12 + i14 * i14 <= (i10 - 1) * (i10 - 1)) && !Block.opaqueCubeLookup[world1.getBlockId(i11, i8, i13)])
						{
