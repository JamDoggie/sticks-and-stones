...
namespace net.minecraft.src
{
    ...
    public class Teleporter
	{
		...
		public virtual bool placeInExistingPortal(World world1, Entity entity2)
		{
			short s3 = 128;
			double d4 = -1.0D;
			int i6 = 0;
		...
		public virtual bool createPortal(World world1, Entity entity2)
		{
			sbyte b3 = 16;
			double d4 = -1.0D;
								...
								for (i24 = 0; i24 < 3; ++i24)
								{
									for (i25 = 0; i25 < 4; ++i25)
									{
										for (i26 = -1; i26 < 4; ++i26)
										{
											...
											if (i26 < 0 && !world1.getBlockMaterial(i27, i28, i29).Solid || i26 >= 0 && !world1.isAirBlock(i27, i28, i29))
											{
												goto label296Continue;
											}
										}
									}
								}
								...
								for (i21 = i13; i21 < i13 + 2; ++i21)
								{
									...
									for (i24 = 0; i24 < 4; ++i24)
									{
										for (i25 = -1; i25 < 4; ++i25)
										{
											...
											i27 = i20 + i25;
											i28 = i17 + (i24 - 1) * i23;
											if (i25 < 0 && !world1.getBlockMaterial(i26, i27, i28).Solid || i25 >= 0 && !world1.isAirBlock(i26, i27, i28))
											{
												goto label234Continue;
											}
										}
									}
