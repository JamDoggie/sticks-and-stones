...
namespace net.minecraft.src
{
	...
	public class MapGenCavesHell : MapGenBase
	{
		...
		protected internal virtual void generateCaveNode(int i1, int i2, sbyte[] b3, double d4, double d6, double d8, float f10, float f11, float f12, int i13, int i14, double d15)
		{
			...
			int i25 = random23.Next(i14 / 2) + i14 / 4;

			for (bool z26 = random23.Next(6) == 0; i13 < i14; ++i13)
			{
		...
		{
			int i7 = this.rand.Next(this.rand.Next(this.rand.Next(10) + 1) + 1);
			...
			for (int i8 = 0; i8 < i7; ++i8)
			{
				...
				double d11 = (double)this.rand.Next(128);
				double d13 = (double)(i3 * 16 + this.rand.Next(16));
				int i15 = 1;
				if (this.rand.Next(4) == 0)
				{
					this.generateLargeCaveNode(i4, i5, b6, d9, d11, d13);
