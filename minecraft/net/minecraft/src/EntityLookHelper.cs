...
namespace net.minecraft.src
{
    public class EntityLookHelper
	{
		...
		private bool field_46147_d = false;
		private double posX;
		private double posY;
		private double posZ;
		...
		public virtual void setLookPositionWithEntity(Entity entity1, float f2, float f3)
		{
			this.posX = entity1.posX;
			if (entity1 is EntityLiving)
			{
				this.posY = entity1.posY + (double)((EntityLiving)entity1).EyeHeight;
			}
			else
			{
		...
		public virtual void setLookPosition(double d1, double d3, double d5, float f7, float f8)
		{
			this.posX = d1;
			this.posY = d3;
			this.posZ = d5;
		...
		public virtual void onUpdateLook()
		{
			...
			if (this.field_46147_d)
			{
				...
				double d3 = this.posY - (this.entity.posY + (double)this.entity.EyeHeight);
