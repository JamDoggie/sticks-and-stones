...
namespace net.minecraft.src
{
	...
	{
		public GenLayerZoom(long j1, GenLayer genLayer3) : base(j1)
		{
			base.parent = genLayer3;
		}

		public override int[] getInts(int i1, int i2, int i3, int i4)
		{
			int i5 = i1 >> 1;
			int i6 = i2 >> 1;
			int i7 = (i3 >> 1) + 3;
			...
			for (int i12 = 0; i12 < i8 - 1; ++i12)
			{
				...
				for (int i17 = 0; i17 < i7 - 1; ++i17)
				{
					...
					i10[i14++ + i11] = this.func_35514_b(i15, i18, i16, i19);
					i15 = i18;
					i16 = i19;
				}
			}
			...
			{
				Array.Copy(i10, (i13 + (i2 & 1)) * (i7 << 1) + (i1 & 1), i20, i13 * i3, i3);
			}

			return i20;
		}

		protected internal virtual int choose(int i1, int i2)
		{
			return this.nextInt(2) == 0 ? i1 : i2;
		}

		protected internal virtual int func_35514_b(int i1, int i2, int i3, int i4)
		{
			if (i2 == i3 && i3 == i4)
			{
				return i2;
		...
		public static GenLayer func_35515_a(long j0, GenLayer genLayer2, int i3)
		{
