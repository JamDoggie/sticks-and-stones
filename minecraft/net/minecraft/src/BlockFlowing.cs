...
namespace net.minecraft.src
{
	...
	{
		internal int numAdjacentSources = 0;
		internal bool[] isOptimalFlowDirection = new bool[4];
		internal int[] flowCost = new int[4];

		protected internal BlockFlowing(int i1, Material material2) : base(i1, material2)
		{
		}

		private void updateFlow(World world1, int i2, int i3, int i4)
		{
		...
		public override void updateTick(World world1, int i2, int i3, int i4, RandomExtended random5)
		{
			...
			if (i6 > 0)
			{
				...
				{
					if (world1.getBlockMaterial(i2, i3 - 1, i4).Solid)
					{
						i10 = 0;
					}
				...
				if (this.blockMaterial == Material.lava && i6 < 8 && i10 < 8 && i10 > i6 && random5.Next(4) != 0)
				{
					i10 = i6;
					z8 = false;
				}
		...
		private void flowIntoBlock(World world1, int i2, int i3, int i4, int i5)
		{
			if (this.liquidCanDisplaceBlock(world1, i2, i3, i4))
			{
				...
				if (i6 > 0)
				{
					...
					{
						Block.blocksList[i6].dropBlockAsItem(world1, i2, i3, i4, world1.getBlockMetadata(i2, i3, i4), 0);
					}
				}
		...
		private bool[] getOptimalFlowDirections(World world1, int i2, int i3, int i4)
		{
			int i5;
			int i6;
			for (i5 = 0; i5 < 4; ++i5)
		...
		private bool blockBlocksFlow(World world1, int i2, int i3, int i4)
		{
			...
			if (i5 != Block.doorWood.blockID && i5 != Block.doorSteel.blockID && i5 != Block.signPost.blockID && i5 != Block.ladder.blockID && i5 != Block.reed.blockID)
			{
				...
				else
				{
					...
					return material6 == Material.portal ? true : material6.blocksMovement();
				}
			}
			else
			{
		...
		protected internal virtual int getSmallestFlowDecay(World world1, int i2, int i3, int i4, int i5)
		{
			int i6 = this.getFlowDecay(world1, i2, i3, i4);
			if (i6 < 0)
			{
		...
		private bool liquidCanDisplaceBlock(World world1, int i2, int i3, int i4)
		{
