...
namespace net.minecraft.src
{
	...
	public class ComponentVillageField2 : ComponentVillage
	{
		...
		public ComponentVillageField2(int i1, RandomExtended random2, StructureBoundingBox structureBoundingBox3, int i4) : base(i1)
		{
		...
		public static ComponentVillageField2 findValidPlacement(System.Collections.IList list0, RandomExtended random1, int i2, int i3, int i4, int i5, int i6)
		{
			StructureBoundingBox structureBoundingBox7 = StructureBoundingBox.getComponentToAddBoundingBox(i2, i3, i4, 0, 0, 0, 7, 4, 9, i5);
			return canVillageGoDeeper(structureBoundingBox7) && StructureComponent.findIntersecting(list0, structureBoundingBox7) == null ? new ComponentVillageField2(i6, random1, structureBoundingBox7, i5) : null;
		}
		...
		public override bool addComponentParts(World world1, RandomExtended random2, StructureBoundingBox structureBoundingBox3)
		{
			...
			this.fillWithBlocks(world1, structureBoundingBox3, 0, 1, 0, 6, 4, 8, 0, 0, false);
			...
			this.fillWithBlocks(world1, structureBoundingBox3, 1, 0, 0, 5, 0, 0, Block.wood.blockID, Block.wood.blockID, false);
			this.fillWithBlocks(world1, structureBoundingBox3, 1, 0, 8, 5, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
