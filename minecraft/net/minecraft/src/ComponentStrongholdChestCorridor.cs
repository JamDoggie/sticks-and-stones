...
namespace net.minecraft.src
{
	...
	public class ComponentStrongholdChestCorridor : ComponentStronghold
	{
		...
		public ComponentStrongholdChestCorridor(int i1, RandomExtended random2, StructureBoundingBox structureBoundingBox3, int i4) : base(i1)
		{
		...
		public static ComponentStrongholdChestCorridor findValidPlacement(System.Collections.IList list0, RandomExtended random1, int i2, int i3, int i4, int i5, int i6)
		{
			StructureBoundingBox structureBoundingBox7 = StructureBoundingBox.getComponentToAddBoundingBox(i2, i3, i4, -1, -1, 0, 5, 5, 7, i5);
			return canStrongholdGoDeeper(structureBoundingBox7) && StructureComponent.findIntersecting(list0, structureBoundingBox7) == null ? new ComponentStrongholdChestCorridor(i6, random1, structureBoundingBox7, i5) : null;
		}
		...
		public override bool addComponentParts(World world1, RandomExtended random2, StructureBoundingBox structureBoundingBox3)
		{
			...
			else
			{
				...
				this.fillWithBlocks(world1, structureBoundingBox3, 3, 1, 2, 3, 1, 4, Block.stoneBrick.blockID, Block.stoneBrick.blockID, false);
				...
				if (!this.hasMadeChest)
				{
					...
					if (structureBoundingBox3.isVecInside(i5, i4, i6))
					{
						...
						this.createTreasureChestAtCurrentPosition(world1, structureBoundingBox3, random2, 3, 2, 3, chestLoot, 2 + random2.Next(2));
					}
				}
