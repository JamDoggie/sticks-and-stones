...
namespace net.minecraft.src
{
    public class PathFinder
	{
		...
		public PathFinder(IBlockAccess iBlockAccess1, bool z2, bool z3, bool z4, bool z5)
		{
		...
		public virtual PathEntity createEntityPathTo(Entity entity1, Entity entity2, float f3)
		{
			return this.createEntityPathTo(entity1, entity2.posX, entity2.boundingBox.minY, entity2.posZ, f3);
		}

		public virtual PathEntity createEntityPathTo(Entity entity1, int i2, int i3, int i4, float f5)
		{
		...
		private PathEntity createEntityPathTo(Entity entity1, double d2, double d4, double d6, float f8)
		{
			...
			bool z9 = this.isPathingInWater;
			int i10 = MathHelper.floor_double(entity1.boundingBox.minY + 0.5D);
			if (this.canEntityDrown && entity1.InWater)
			{
		...
		private PathEntity addToPath(Entity entity1, PathPoint pathPoint2, PathPoint pathPoint3, PathPoint pathPoint4, float f5)
		{
			...
			while (!this.path.PathEmpty)
			{
				...
				for (int i9 = 0; i9 < i8; ++i9)
				{
					...
					if (!pathPoint10.Assigned || f11 < pathPoint10.totalPathDistance)
					{
		...
		private PathPoint openPoint(int i1, int i2, int i3)
		{
