...
namespace net.minecraft.src
{
	...
	public class NoiseGeneratorPerlin : NoiseGenerator
	{
		...
		public double func_4110_a(int i1, double d2, double d4)
		{
			int i6 = i1 & 15;
		...
		public virtual void func_805_a(double[] d1, double d2, double d4, double d6, int i8, int i9, int i10, double d11, double d13, double d15, double d17)
		{
			int i10001;
			int i19;
			int i22;
