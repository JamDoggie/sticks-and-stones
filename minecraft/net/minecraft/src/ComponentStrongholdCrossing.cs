...
namespace net.minecraft.src
{
	...
	public class ComponentStrongholdCrossing : ComponentStronghold
	{
		...
		public ComponentStrongholdCrossing(int i1, RandomExtended random2, StructureBoundingBox structureBoundingBox3, int i4) : base(i1)
		{
			this.coordBaseMode = i4;
			this.doorType = this.getRandomDoor(random2);
			this.boundingBox = structureBoundingBox3;
			this.field_35042_b = random2.NextBool();
			this.field_35043_c = random2.NextBool();
			this.field_35040_d = random2.NextBool();
			this.field_35041_e = random2.Next(3) > 0;
		}
		...
		public static ComponentStrongholdCrossing findValidPlacement(System.Collections.IList list0, RandomExtended random1, int i2, int i3, int i4, int i5, int i6)
		{
			StructureBoundingBox structureBoundingBox7 = StructureBoundingBox.getComponentToAddBoundingBox(i2, i3, i4, -4, -3, 0, 10, 9, 11, i5);
			return canStrongholdGoDeeper(structureBoundingBox7) && StructureComponent.findIntersecting(list0, structureBoundingBox7) == null ? new ComponentStrongholdCrossing(i6, random1, structureBoundingBox7, i5) : null;
		}
		...
		public override bool addComponentParts(World world1, RandomExtended random2, StructureBoundingBox structureBoundingBox3)
		{
			...
			{
				this.fillWithRandomizedBlocks(world1, structureBoundingBox3, 0, 0, 0, 9, 8, 10, true, random2, StructureStrongholdPieces.StrongholdStones);
				...
				this.fillWithRandomizedBlocks(world1, structureBoundingBox3, 1, 2, 1, 8, 2, 6, false, random2, StructureStrongholdPieces.StrongholdStones);
				this.fillWithRandomizedBlocks(world1, structureBoundingBox3, 4, 1, 5, 4, 4, 9, false, random2, StructureStrongholdPieces.StrongholdStones);
				this.fillWithRandomizedBlocks(world1, structureBoundingBox3, 8, 1, 5, 8, 4, 9, false, random2, StructureStrongholdPieces.StrongholdStones);
				this.fillWithRandomizedBlocks(world1, structureBoundingBox3, 1, 4, 7, 3, 4, 9, false, random2, StructureStrongholdPieces.StrongholdStones);
				this.fillWithRandomizedBlocks(world1, structureBoundingBox3, 1, 3, 5, 3, 3, 6, false, random2, StructureStrongholdPieces.StrongholdStones);
				...
				this.fillWithRandomizedBlocks(world1, structureBoundingBox3, 5, 1, 7, 7, 1, 8, false, random2, StructureStrongholdPieces.StrongholdStones);
